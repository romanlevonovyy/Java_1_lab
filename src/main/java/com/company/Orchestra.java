...
public class Orchestra extends Performance {
    ...
    public Orchestra(final double price, final int employees, final int duration, final boolean isHaveMusician, final int conductor, final int costumer, final int violinist) {
        super(price, employees, duration, isHaveMusician, PerformanceType.ORCHESTRA);
