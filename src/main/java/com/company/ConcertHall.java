...
public final class ConcertHall {
    ...
    public List<Performance> findByShowWithMusician(final PerformanceType performanceType) {
        List<Performance> result = new LinkedList<>();
        performanceList.stream().filter((goodList) ->
                ((goodList.getPerformanceType() == performanceType)))
