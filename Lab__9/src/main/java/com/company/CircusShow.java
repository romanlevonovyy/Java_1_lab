...
public class CircusShow extends Performance {
    ...
    public CircusShow(final double price, final int employees, final int duration, final boolean isHaveMusician,
                      final String director, final String acrobats, final int participants, final int lions, final Integer id) {
        super(price, employees, duration, isHaveMusician, PerformanceType.CIRCUSSHOW, id);
    ...
    public final String getHeaders() {
        return super.getHeaders() + "," + "Director" + "," + "Acrobats" + "," + "Participants" + "," + "Lions";
    }

    @Override
    public final String toCVS() {
        return super.toCVS() + "," + getDirector() + "," + getAcrobats() + "," + getParticipants() + "," + getLions();
    }
    ...
    public final String toString() {
        return "CircusShow{" + super.toString() +
                ...
                ", lions = " + getLions() +
                ", performance type = " + getPerformanceType() +
                '}';
    }
